...
*/
#define TMR2_INTERRUPT_TICKER_FACTOR  7   // tunned (together with PR2) to 100ms interval
  
#define POWER_DOWN_TICKER_FACTOR      80  // 8 seconds (n * 100ms)
#define BUTTON_TICKER_FACTOR          4   // 0.4 seconds (n * 100ms)
#define LED_BLINK_PERIOD              10   // blink period (n * 100ms)
#define LED_BLINK_DURATION            8   // should be smaller than LED_BLINK_PERIOD (n * 100ms)
